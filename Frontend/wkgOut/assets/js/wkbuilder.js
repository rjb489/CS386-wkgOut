...
document.addEventListener('DOMContentLoaded', function() 
{
    ...
    form.addEventListener('submit', function(event) {
        ...
        else if(formValues.workoutLength == "30min" && formValues.workoutStage == "Intermediate" && formValues.workoutType == "Weights")
        {
            var selectedWorkout = intermediate30MinWithWeights;
            console.log( selectedWorkout );
        }
        else if(formValues.workoutLength == "45min" && formValues.workoutStage == "Intermediate" && formValues.workoutType == "Weights")
        {
            var selectedWorkout = intermediate45MinWithWeights;
            console.log( selectedWorkout );
        }
        else if(formValues.workoutLength == "60min" && formValues.workoutStage == "Intermediate" && formValues.workoutType == "Weights")
        {
            var selectedWorkout = intermediate60MinWithWeights;
            console.log( selectedWorkout );
        }
        else if(formValues.workoutLength == "30min" && formValues.workoutStage == "Intermediate" && formValues.workoutType == "Body Weight")
        {
            var selectedWorkout = intermediate30MinWithoutWeights;
            console.log( selectedWorkout );
        }
        else if(formValues.workoutLength == "45min" && formValues.workoutStage == "Intermediate" && formValues.workoutType == "Body Weight")
        {
            var selectedWorkout = intermediate45MinWithoutWeights;
            console.log( selectedWorkout );
        }
        else if(formValues.workoutLength == "60min" && formValues.workoutStage == "Intermediate" && formValues.workoutType == "Body Weight")
        {
